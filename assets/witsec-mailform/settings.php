...
$_SETTINGS = [
	"to"						=> "support@itmedic.in",							// To Address
	"toAlt"						=> "",						// Additional Recipients
	"from"						=> "support@itmedic.in",						// From Address
	...
	"template"					=> "Hi,<br><br>You have received a new message from IT Medic Site.<br><br>{formdata}<br><br>Date: {date}<br>Remote IP: {ip}<br><br>---<br>Have a nice day.",					// Mail Template
